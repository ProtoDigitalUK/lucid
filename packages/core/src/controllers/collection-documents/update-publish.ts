...
const updatePublishController: RouteController<
	typeof collectionDocumentsSchema.updatePublish.params,
	typeof collectionDocumentsSchema.updatePublish.body,
	typeof collectionDocumentsSchema.updatePublish.query
> = async (request, reply) => {
...
export default {
	controller: updatePublishController,
	zodSchema: collectionDocumentsSchema.updatePublish,
	swaggerSchema: {
		description: "Update a single collection documents published version.",
		tags: ["collection-documents"],
		summary: "Update a single collection documents published version.",
		body: {
			type: "object",
			properties: {
				bricks: {
