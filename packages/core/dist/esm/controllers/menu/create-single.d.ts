declare const _default: {
    schema: {
        body: import("zod").ZodObject<{
            ...
            items: import("zod").ZodOptional<import("zod").ZodArray<import("zod").ZodType<import("../../schemas/menus.js").MenuItem, import("zod").ZodTypeDef, import("../../schemas/menus.js").MenuItem>, "many">>;
        }, "strip", import("zod").ZodTypeAny, {
            name: string;
            key: string;
            description?: string | undefined;
            items?: import("../../schemas/menus.js").MenuItem[] | undefined;
        }, {
            name: string;
            key: string;
            description?: string | undefined;
