declare const _default: {
    ...
    hasEnvironmentPermission: (client: import("pg").PoolClient, data: import("./has-environment-permission").ServiceData) => Promise<import("@lucid/types/src/environments").EnvironmentResT>;
