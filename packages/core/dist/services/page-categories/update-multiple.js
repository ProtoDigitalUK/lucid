...
const updateMultiple = async (client, data) => {
    const pageCategoriesRes = await PageCategory_1.default.getMultipleByPageId(client, {
    ...
    if (categoriesToAdd.length > 0) {
        updatePromise.push((0, service_1.default)(page_categories_1.default.createMultiple, false, client)({
            page_id: data.page_id,
    ...
    if (categoriesToRemove.length > 0) {
        updatePromise.push((0, service_1.default)(page_categories_1.default.deleteMultiple, false, client)({
            page_id: data.page_id,
