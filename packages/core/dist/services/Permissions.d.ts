export type PermissionT = "create_user" | "read_users" | "update_user" | "delete_user" | "create_role" | "read_role" | "update_role" | "delete_role" | "create_media" | "read_media" | "update_media" | "delete_media" | "update_environment" | "migrate_environment" | "delete_environment" | "create_environment" | "update_settings" | "read_email" | "delete_email" | "send_email";
