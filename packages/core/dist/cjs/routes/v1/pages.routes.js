...
const create_single_js_1 = __importDefault(require("../../controllers/pages/create-single.js"));
const get_multiple_js_1 = __importDefault(require("../../controllers/pages/get-multiple.js"));
const get_single_js_1 = __importDefault(require("../../controllers/pages/get-single.js"));
const update_single_js_1 = __importDefault(require("../../controllers/pages/update-single.js"));
const delete_single_js_1 = __importDefault(require("../../controllers/pages/delete-single.js"));
