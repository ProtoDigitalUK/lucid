...
const getMultiple = async (client, data) => {
    ...
    const formSubmissionsRes = await FormSubmission_js_1.default.getMultiple(client, SelectQuery);
    ...
    if (include?.includes("fields")) {
        ...
        formData = await FormSubmission_js_1.default.getAllFormData(client, {
