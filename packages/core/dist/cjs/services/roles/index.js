...
const check_name_unique_js_1 = __importDefault(require("./check-name-unique.js"));
const validate_permissions_js_1 = __importDefault(require("./validate-permissions.js"));
exports.default = {
    ...
    checkNameIsUnique: check_name_unique_js_1.default,
    validatePermissions: validate_permissions_js_1.default,
};
