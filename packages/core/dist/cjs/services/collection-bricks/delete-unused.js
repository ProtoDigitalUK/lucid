...
const deleteUnused = async (client, data) => {
    const allBricks = await CollectionBrick_js_1.default.getAllBricks(client, {
        type: data.type,
    ...
    const promises = bricksToDelete.map((id) => CollectionBrick_js_1.default.deleteSingleBrick(client, {
        brick_id: id,
    }));
    try {
