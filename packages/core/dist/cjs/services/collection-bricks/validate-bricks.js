...
const index_js_3 = __importDefault(require("../media/index.js"));
...
const getAllMedia = async (client, fields) => {
    try {
        ...
        const media = await (0, service_js_1.default)(index_js_3.default.getMultipleByIds, false, client)({
            ids: ids,
        });
        return media;
    }
...
const getAllPages = async (client, fields, environment_key) => {
    try {
        ...
        const ids = getIDs
            .filter((id) => id !== undefined)
            .filter((value, index, self) => self.indexOf(value) === index);
        const pages = await (0, service_js_1.default)(index_js_2.default.getMultipleById, false, client)({
            ids,
            environment_key,
        });
        return pages;
