...
const generate_field_query_js_1 = __importDefault(require("../../utils/bricks/generate-field-query.js"));
class CollectionBrick {
    ...
    static updateField = async (client, data) => {
        const { columns, aliases, values } = (0, generate_field_query_js_1.default)({
