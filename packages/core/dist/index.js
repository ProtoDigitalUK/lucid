...
var baseCustomFieldSchema = z7.object({
  ...
  // boolean or string
  default: z7.union([z7.boolean(), z7.string(), z7.number(), z7.undefined(), z7.object({})]).optional(),
  options: z7.array(
    z7.object({
      label: z7.string(),
      value: z7.string()
...
var updateSingleBody2 = z9.object({
  ...
  slug: z9.string().optional(),
  homepage: z9.boolean().optional(),
  parent_id: z9.number().nullable().optional(),
  author_id: z9.number().nullable().optional(),
  category_ids: z9.array(z9.number()).optional(),
  published: z9.boolean().optional(),
  excerpt: z9.string().optional()
});
...
var getMultipleValidParentsBody = z9.object({});
var getMultipleValidParentsQuery = z9.object({
  filter: z9.object({
    collection_key: z9.union([z9.string(), z9.array(z9.string())]).optional(),
    title: z9.string().optional()
  }).optional(),
...
var getMultipleValidParentsParams = z9.object({
  id: z9.string()
});
var pages_default = {
  getMultiple: {
...
var formatFields = ({
  ...
  fields.forEach((field) => {
    ...
    matchingBrickFields.forEach((brickField) => {
      ...
      if (brickField.type === "tab")
        return;
      if (brickField.type === "repeater")
        return;
      if (brickField) {
        let fieldsData = {
...
var buildUniqueSlug = async (client, data) => {
  ...
  data.slug = slug2(data.slug, { lower: true });
...
var resetHomepages = async (client, data) => {
  ...
  const updatePromises = homepages.map(async (homepage) => {
    let newSlug = slug3(homepage.title, { lower: true });
...
var CollectionOptionsSchema = z23.object({
  ...
  disableHomepage: z23.boolean().optional(),
  disableParent: z23.boolean().optional(),
  bricks: z23.array(
    z23.object({
      key: z23.string(),
