CREATE TABLE IF NOT EXISTS headless_collection_bricks (
    ...
    multiple_builder_id INT REFERENCES headless_collection_multiple_builder(id) ON DELETE CASCADE,
    single_builder_id INT REFERENCES headless_collection_single_builder(id) ON DELETE CASCADE,
