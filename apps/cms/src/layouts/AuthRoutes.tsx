...
const AuthRoutes: Component<AuthRoutesProps> = (props) => {
	...
	return (
		<div class="fixed top-0 left-0 bottom-0 right-0 flex ">
			<div class="w-full xl:w-[40%] xl:min-w-[800px] h-full bg-container-3 overflow-y-auto flex items-center justify-center relative">
				<div class="m-auto px-10 py-20 w-full max-w-[600px] ">
					{props.children}
				</div>
			</div>
			<div class="hidden w-[60%] bg-primary-base xl:flex items-center justify-center text-primary-contrast relative">
