...
const NavigationLink: Component<NavigationLinkProps> = (props) => {
  ...
  return (
    <Link
      href={props.href}
      class={classNames(
        "w-10 h-10 focus:outline-none focus:!border-primary focus:ring-0 flex items-center justify-center bg-white mb-2.5 last:mb-0 rounded-lg border border-transparent transition-colors duration-200 ease-in-out hover:border-primary"
      )}
