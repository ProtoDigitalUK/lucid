      ...
      >
        <div
          class={classNames("h-full rounded-md duration-200 transition-all", {
            // usage
            "bg-error": props.type === "usage" && getProgress() > 90,
            "bg-secondary": props.type === "usage" && getProgress() <= 90,
            // target
            "bg-primary ": props.type === "target" && getProgress() > 90,
            "bg-secondary ": props.type === "target" && getProgress() <= 90,
          })}
          style={{
            width: `${getProgress()}%`,
          }}
